...
# Source config
# -----------------------------
jdbc_url = "jdbc:postgresql://postgres_db:5432/subscription"
table_name = "public.payments"

# Use a path that is mounted and shared between Airflow + Spark containers
bronze_path = "/spark-data/bronze/payments"
audit_path = "/spark-data/bronze/_audit/payments_validation"
expected_columns = ['id',
                    'payment_id',
                    'subscription_id',
                    'amount',
